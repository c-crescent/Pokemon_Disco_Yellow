...
; entries correspond to TRADE_FOR_* constants
	...
	db LICKITUNG,  CHANSEY,   TRADE_DIALOGSET_CASUAL,    "GURIO@@@@@@"
	...
	db TANGELA,    TAUROS,    TRADE_DIALOGSET_CASUAL,    "SPIKE@@@@@@"
	db POLIWHIRL,  JYNX,      TRADE_DIALOGSET_EVOLUTION, "LOLA@@@@@@@"
	db GOLDUCK,    KANGASKHAN,TRADE_DIALOGSET_EVOLUTION, "BUFFY@@@@@@"
	db GROWLITHE,  DEWGONG,   TRADE_DIALOGSET_HAPPY,     "CEZANNE@@@@"
	db CUBONE,     KANGASKHAN,   TRADE_DIALOGSET_HAPPY,     "RICKY@@@@@@"
