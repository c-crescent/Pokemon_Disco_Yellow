...
; Characteristics of each move.
	...
	move VICEGRIP,     NO_ADDITIONAL_EFFECT,        100, NORMAL,      100, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move RAZOR_WIND,   HYPER_BEAM_EFFECT,           90, BUG,          100, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, BIRD,         100, 30
	move CUT,          NO_ADDITIONAL_EFFECT,        55, BUG,          100, 30
	move GUST,         NO_ADDITIONAL_EFFECT,        50, FLYING,       100, 35
	...
	move HORN_ATTACK,  SWIFT_EFFECT,    		    65, NORMAL,       100, 25
	...
	move TAKE_DOWN,    CHARGE_EFFECT,              150, NORMAL,       100, 20
	...
	move SUBMISSION,   RECOIL_EFFECT,              100, FIGHTING,     100, 25
	...
	move DRAGON_RAGE,  NO_ADDITIONAL_EFFECT,        65, DRAGON,       100, 20
	...
	move SKULL_BASH,   HYPER_BEAM_EFFECT,          120, NORMAL,       100, 15
	...
	move FLASH,        ACCURACY_DOWN1_EFFECT,        0, BIRD,          90, 20
	...
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         50, GROUND,       100, 20
	move REST,         HEAL_EFFECT,                  0, BIRD,         100, 10
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT1,         75, ROCK,          95, 15
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         80, NORMAL,       100, 15
