SuperRodFishingSlots::
	...
	db SEAFOAM_ISLANDS_B3F, KRABBY, 35, STARYU, 35, KINGLER, 40, STARMIE, 40
	db SEAFOAM_ISLANDS_B4F, KINGLER, 40, STARYU, 40, OMANYTE, 35, KABUTO, 35
	db CERULEAN_CAVE_1F, SEAKING, 55, POLIWRATH, 55, CLOYSTER, 55, DRATINI, 55
	db CERULEAN_CAVE_B1F, STARMIE, 60, KINGLER, 60, CLOYSTER, 60, LAPRAS, 60
	db -1 ; end
