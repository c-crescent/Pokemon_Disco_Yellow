...
CeladonMart2FClerk1Text::
	script_mart TM_WATER_GUN, TM_THUNDER_WAVE, TM_SWIFT, TM_SEISMIC_TOSS, TM_REST, TM_BIDE, TM_TELEPORT, TM_PAY_DAY

CeladonMart2FClerk2Text::
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_RAZOR_WIND, TM_SKULL_BASH, TM_EGG_BOMB, TM_MEGA_PUNCH, TM_MEGA_KICK, TM_TAKE_DOWN, TM_RAGE, TM_BODY_SLAM
