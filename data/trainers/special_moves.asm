...
SpecialTrainerMoves:
	...
	db LT_SURGE, 1 ; 22, VOLTORB, 22, MAGNEMITE, 23, ELECTABUZZ, 24 RAICHU
	db 4, 1, THUNDERBOLT
	db 4, 2, THUNDER_WAVE
	db 4, 3, BODY_SLAM
	db 4, 4, SURF
	...
	db LORELEI, 1 ; 56, SLOWBRO, 55, CLOYSTER, 55, DEWGONG, 56, STARMIE, 56, JYNX, 57, LAPRAS, 0
	db 1, 1, EARTHQUAKE
	db 1, 2, BLIZZARD
	db 2, 1, SURF
	db 2, 3, EXPLOSION
	...
	db BRUNO, 1 ; 57, HITMONCHAN, 56, POLIWRATH, 57, HITMONLEE, 56, ONIX, 56, PRIMEAPE, 58, MACHAMP
	db 1, 3, ICE_PUNCH
	db 1, 4, THUNDERPUNCH
	db 2, 1, ICE_BEAM
	db 3, 1, BODY_SLAM
	...
	db AGATHA, 1 ; 57, GENGAR, 58, GOLBAT, 57, MAROWAK, 58, ARBOK, 58, VENUSAUR 59, GENGAR
	db 1, 1, MEGA_DRAIN
	db 2, 1, FLY
	db 2, 2, TOXIC
	db 2, 4, SUPER_FANG
	...
	db LANCE, 1 ; 61, DRAGONITE, 60, GYARADOS, 60, CHARIZARD, 61, AERODACTYL, 61, SEADRA, 62, DRAGONITE
	db 1, 1, WRAP
	db 1, 3, THUNDER_WAVE
	db 2, 1, FLY
	db 2, 2, SURF
	...
	db PROF_OAK, 2 ; 90, TAUROS, 90, ZAPDOS, 90, ARTICUNO, 90, MOLTRES, 90, SNORLAX, 90, NIDOKING
	...
	db BRUNO, 2 ; 71, HITMONCHAN, 71, POLIWRATH, 71, HITMONLEE, 72, GOLEM, 72, PRIMEAPE, 73, MACHAMP
	db 1, 1, SUBMISSION
	db 1, 2, THUNDERPUNCH
	db 1, 3, ICE_PUNCH
	db 1, 4, FIRE_PUNCH
	...
	db LANCE, 2 ; 73, DRAGONITE, 73, GYARADOS, 73, CHARIZARD, 74, AERODACTYL, 74, SEADRA, 75, DRAGONITE
	db 1, 1, DRAGON_CLAW
    db 1, 2, THUNDER
    db 1, 3, FIRE_BLAST
    db 1, 4, BLIZZARD
