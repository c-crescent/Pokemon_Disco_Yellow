...
; Postgame Fight
	...
	db $FF, 90, TAUROS, 90, ZAPDOS, 90, ARTICUNO, 90, MOLTRES, 90, SNORLAX, 90, NIDOKING, 0
...
BrunoData:
	db $FF, 57, HITMONCHAN, 56, POLIWRATH, 57, HITMONLEE, 56, ONIX, 56, PRIMEAPE, 58, MACHAMP, 0
; Rematch
	db $FF, 71, HITMONCHAN, 71, POLIWRATH, 71, HITMONLEE, 72, GOLEM, 72, PRIMEAPE, 73, MACHAMP, 0
...
LtSurgeData:
	db $FF, 22, VOLTORB, 22, MAGNEMITE, 23, ELECTABUZZ, 24, RAICHU, 0
; Rematch
...
; Rematch
	db $FF, 77, ALAKAZAM, 77, MACHAMP, 77, VAPOREON, 77, JOLTEON, 7, EXEGGUTOR, 77, FLAREON, 0

LoreleiData:
	db $FF, 56, SLOWBRO, 55, CLOYSTER, 55, DEWGONG, 56, STARMIE, 56, JYNX, 57, LAPRAS, 0
; Rematch
	db $FF, 70, SLOWBRO, 70, CLOYSTER, 70, DEWGONG, 71, STARMIE, 71, JYNX, 72, LAPRAS, 0
...
AgathaData:
	db $FF, 57, GENGAR, 58, GOLBAT, 57, MAROWAK, 58, ARBOK, 58, VENUSAUR, 59, GENGAR, 0
; Rematch
	db $FF, 72, GENGAR, 72, GOLBAT, 72, MAROWAK, 73, ARBOK, 73, VENUSAUR, 74, GENGAR, 0

LanceData:
	db $FF, 61, DRAGONITE, 60, GYARADOS, 60, CHARIZARD, 61, AERODACTYL, 61, SEADRA, 62, DRAGONITE, 0
; Rematch
	db $FF, 73, DRAGONITE, 73, GYARADOS, 73, CHARIZARD, 74, AERODACTYL, 74, SEADRA, 75, DRAGONITE, 0
